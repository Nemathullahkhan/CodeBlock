...
//   return (
//     <div className="h-full flex flex-col bg-black rounded-xl p-4 ring-2 ring-zinc-900 overflow-y-scroll">
//       {/* Confetti Animation */}
//       {showConfetti && (
//         <>
//           <Confetti
...
import { useCodeEditorStore } from "@/store/useCodeEditorStore"
import { AlertTriangle, CheckCircle, ChevronDown, ChevronUp, Clock, Copy, Terminal, XCircle } from "lucide-react"
import { useEffect, useState } from "react"
import Confetti from "react-confetti"
import SubmitButton from "./SubmitButton"
...
export default function QuestionOutputPanel({ questionId }: { questionId: string }) {
  ...
  return (
    <div className="h-full flex flex-col bg-black rounded-xl p-4 ring-2 ring-zinc-900">
      ...
      {showConfetti && (
        <>
          <Confetti className="flex justify-center" width={window.innerWidth} height={200} recycle={false} />
          <div className="bg-green-800/20 text-green-400 p-3 rounded-md mb-4 text-center">
            <h3 className="font-bold text-lg">All Test Cases Passed! 🎉</h3>
            <p>You can now submit your solution</p>
          </div>
      ...
      <div className="relative flex-grow overflow-auto">
        <div
          className="h-full relative bg-black rounded-xl p-4 text-sm"
          style={{
            fontFamily: '"Fira Code","Cascadia Code",Consolas, monospace',
            fontSize: "14px",
            lineHeight: "1.5",
          ...
          {isRunning ? (
            ...
            <div className="flex items-start gap-3 text-red-400">
              ...
              <div className="space-y-1">
                ...
                <pre className="whitespace-pre-wrap text-red-400/80">{error.split(":")[1]?.trim() || error}</pre>
              </div>
            </div>
          ) : testCaseResults.length > 0 ? (
            <div className="space-y-4">
