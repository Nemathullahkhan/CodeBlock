...
import SaveProgramModal from "./_components/SaveProgramModel";
 // Import the SaveProgramModal component
...
export default function Page() {
  ...
  const [isLoading, setIsLoading] = useState(true);
  const [isSaveModalOpen, setIsSaveModalOpen] = useState(false); // State to control modal visibility
    ...
    <div className="h-screen overflow-hidden p-4">
      <div className="max-w-[1800px] mx-auto h-full">
        <div className="flex items-center justify-between px-10 py-2 border-b-4 border-zinc-800  w-full">
          ...
          <div className="flex  justify-end items-center gap-4 px-10">
            <Button variant={"default"} className="h-6 bg-emerald-700 hover:bg-zinc-950 text-primary font-thin text-md tracking-tight" onClick={() => setIsSaveModalOpen(true)}>
              Save Program
            </Button>
            {status === "authenticated" ? (
                <UserBadge/>
              ...
              <>
                <Link href="/auth/signin" className="text-sm font-medium hover:text-indigo-400">
                  <Button variant="default" className="h-5">Sign In</Button>
                </Link>
                <Link href="/auth/signup" className="text-sm font-medium hover:text-indigo-400">Sign Up</Link>
              </>
            )}
        ...
        {/* Save Program Modal */}
        <SaveProgramModal isOpen={isSaveModalOpen} onClose={() => setIsSaveModalOpen(false)} />
      </div>
    </div>
  );
}
