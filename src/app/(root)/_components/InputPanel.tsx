  ...
  return (
    <div className="relative bg-black rounded-xl p-4 ring-2 ring-zinc-900">
      ...
      <div className="relative">
        <textarea
          className="w-full p-3 text-white bg-black h-[150px] border border-zinc-800 rounded-xl resize-none overflow-auto 
               focus-visible:outline-none focus:border-zinc-600 scrollbar-thin scrollbar-thumb-zinc-600 
               scrollbar-track-black hover:scrollbar-thumb-zinc-500 transition-all monaco-cursor"
          value={userInput}
