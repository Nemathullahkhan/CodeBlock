...
export default function LanguageSelector() {
  ...
  return (
    <Select value={language} onValueChange={setLanguage}>
      <SelectTrigger className="relative group flex items-center gap-2 w-36 px-3 py-2 rounded-lg border border-zinc-800 bg-zinc-900/50 backdrop-blur-md hover:bg-zinc-800/50 transition-all duration-300">
