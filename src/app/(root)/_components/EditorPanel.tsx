                        ...
                        onMount={(editor, monaco) => {
                            ...
                            switch (LANGUAGE_CONFIG[language].monacoLanguage) {
                                ...
                                case "python":
                                    ...
                                    monaco.languages.python.diagnostics = monaco.languages.python.diagnostics || {};
                                ...
                                case "cpp":
                                    ...
                                    monaco.languages.cpp.diagnostics = monaco.languages.cpp.diagnostics || {};
                                ...
                                case "java":
                                    ...
                                    monaco.languages.java.diagnostics = monaco.languages.java.diagnostics || {};
