export const nQueensData = {
    ...
    content: {
      ...
      complexityAnalysis: "O(N!), since each queen has N choices initially, leading to an exponential growth in possibilities.",
      applications: [
    ...
    faq: [
      ...
      },
      {
        ...
        answer: "Backtracking systematically explores all possible queen placements and eliminates invalid configurations early, making it an efficient approach.",
        contentId: "cm7ja3jju000hbugs0bx8uvid",
      },
    ],
    vivaQuestions: [
      {
        question: "What is the base case for solving the N-Queens problem using backtracking?",
        answer: "The base case occurs when all N queens are successfully placed on the board without conflicts.",
        contentId: "cm7ja3jju000hbugs0bx8uvid",
      },
      {
        question: "What is the time complexity of the N-Queens solution using backtracking?",
        answer: "The worst-case time complexity is O(N!), where N is the size of the chessboard.",
        contentId: "cm7ja3jju000hbugs0bx8uvid",
      },
    ],
    working: {
    ...
    implementation: {
      ...
      approach:
        `1. Place a queen in the first available column in a row.\n
